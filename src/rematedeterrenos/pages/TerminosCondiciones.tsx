...
import TableOfContents from "../components/TerminosyCondiciones/TableOfContents/TableOfContents";
import { Section } from "../components/TerminosyCondiciones/Section";
