        ...
        <div className="flex flex-col gap-4 max-w-[380px]">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            >
              ...
              <span className="max-[1163px]:text-xs mt-1 block text-base font-semibold text-white">+56 9 4943 7974</span>
            </a>
            <a
            ...
            >
              ...
              <span className="max-[1163px]:text-xs mt-1 block text-base font-semibold text-white break-all">contacto@rematedeterrenos.cl</span>
            </a>
          </div>
        </div>
